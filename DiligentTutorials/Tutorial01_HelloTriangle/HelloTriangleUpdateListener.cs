...
{
    class HelloTriangleUpdateListener : UpdateListener, IDisposable
    {
          ...
          out PSOutput PSOut)
{
    PSOut.Color = float4(PSIn.Color.rgb, 1.0);
        ...
        public HelloTriangleUpdateListener(GenericEngineFactory genericEngineFactory)
        {
        ...
        public void sendUpdate(Clock clock)
        {
            ...
            //var ClearColor = Color.LightBlue;
            //ClearColor.r = (color.r + (clock.CurrentTimeMicro % 3000000f) / 3000000f) % 1.0f;
            //ClearColor.g = (color.g + (clock.CurrentTimeMicro % 6000000f) / 6000000f) % 1.0f;
            //ClearColor.b = (color.b + (clock.CurrentTimeMicro % 9000000f) / 9000000f) % 1.0f;
