...
namespace GameAppTestAndroid
{
    [Activity(Label = "GameApp Android", MainLauncher = true, Icon = "@drawable/icon", Theme = "@style/AnomalousAndroidTheme",
    ...
    public class MainActivity : AndroidActivity
    {
        ...
        private void App_Initialized(GameApp app)
        {
