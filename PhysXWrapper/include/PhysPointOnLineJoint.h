...
/// <summary>
/// Wrapper for NxPointOnLineJoint.
/// </summary>
[Engine::Attributes::NativeSubsystemType]
public ref class PhysPointOnLineJoint : public PhysJoint
{
internal:
	/// <summary>
	/// Constructor
	/// </summary>
	PhysPointOnLineJoint(Engine::Identifier^ name, NxPointOnLineJoint* joint, PhysActor^ actor0, PhysActor^ actor1, PhysScene^ scene);
...
public:
	...
	void saveToDesc(PhysPointOnLineJointDesc^ desc);
	...
	void loadFromDesc(PhysPointOnLineJointDesc^ desc);
};
