...
Plane::Plane(Engine::Vector3 normal, float constant)
...
Plane::Plane(Engine::Vector3 normal, Engine::Vector3 point)
:ogrePlane(new Ogre::Plane(MathUtils::copyVector3(normal), MathUtils::copyVector3(point)))
{

}

Plane::Plane(Engine::Vector3 point0, Engine::Vector3 point1, Engine::Vector3 point2)
...
Plane::Side Plane::getSide(Engine::Vector3 point)
{
