...
extern "C" _AnomalousExport void Light_setPosition(Ogre::Light* light, Vector3 pos)
{
	light->setPosition(pos.toOgre());
}

extern "C" _AnomalousExport void Light_setPositionRaw(Ogre::Light* light, float x, float y, float z)
{
	light->setPosition(x, y, z);
}

extern "C" _AnomalousExport Vector3 Light_getPosition(Ogre::Light* light)
{
	return light->getPosition();
}

extern "C" _AnomalousExport void Light_setDirectionRaw(Ogre::Light* light, float x, float y, float z)
{
