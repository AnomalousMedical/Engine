...
extern "C" _AnomalousExport void Camera_setPolygonMode(Ogre::Camera* camera, Ogre::PolygonMode mode)
{
	camera->setPolygonMode(mode);
}

extern "C" _AnomalousExport Ogre::PolygonMode Camera_getPolygonMode(Ogre::Camera* camera)
{
