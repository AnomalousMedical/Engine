...
extern "C" _AnomalousExport MovableTypes MovableObject_getMovableType(Ogre::MovableObject* movableObject)
{
	...
	if(type.compare(Ogre::v1::EntityFactory::FACTORY_TYPE_NAME) == 0)
	{
		return Entity;	
	}
	...
	else if(type.compare(Ogre::v1::ManualObjectFactory::FACTORY_TYPE_NAME) == 0)
	{
		return ManualObject;	
	}
	else if(type.compare(Ogre::v1::BillboardChainFactory::FACTORY_TYPE_NAME) == 0)
	{
		return BillboardChain;	
	}
	else if(type.compare(Ogre::v1::RibbonTrailFactory::FACTORY_TYPE_NAME) == 0)
	{
		return RibbonTrail;	
	}
	else if(type.compare(Ogre::v1::BillboardSetFactory::FACTORY_TYPE_NAME) == 0)
	{
		return BillboardSet;	
	}
