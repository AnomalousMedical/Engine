...
extern "C" _AnomalousExport Ogre::v1::Entity* SceneManager_createEntity(Ogre::SceneManager* sceneManager, String entityName, String meshName)
{
	return sceneManager->createEntity(entityName, meshName);
}

extern "C" _AnomalousExport Ogre::v1::Entity* SceneManager_getEntity(Ogre::SceneManager* sceneManager, String name)
{
...
extern "C" _AnomalousExport void SceneManager_destroyEntity(Ogre::SceneManager* sceneManager, Ogre::v1::Entity* entity)
{
	sceneManager->destroyEntity(entity);
}

extern "C" _AnomalousExport Ogre::v1::ManualObject* SceneManager_createManualObject(Ogre::SceneManager* sceneManager, String name)
{
	return sceneManager->createManualObject(name);
}

extern "C" _AnomalousExport Ogre::v1::ManualObject* SceneManager_getManualObject(Ogre::SceneManager* sceneManager, String name)
{
...
extern "C" _AnomalousExport void SceneManager_destroyManualObject(Ogre::SceneManager* sceneManager, Ogre::v1::ManualObject* obj)
{
	sceneManager->destroyManualObject(obj);
}

extern "C" _AnomalousExport Ogre::v1::StaticGeometry* SceneManager_createStaticGeometry(Ogre::SceneManager* sceneManager, String name)
{
	return sceneManager->createStaticGeometry(name);
}

extern "C" _AnomalousExport Ogre::v1::StaticGeometry* SceneManager_getStaticGeometry(Ogre::SceneManager* sceneManager, String name)
{
...
extern "C" _AnomalousExport void SceneManager_destroyStaticGeometry(Ogre::SceneManager* sceneManager, Ogre::v1::StaticGeometry* obj)
{
