...
uniform sampler2D opacityGlossTexture; //The Opacity map, uses r channel for opacity
...
void main()
{
	...
	#ifdef ALPHA
		gl_FragColor.a = opacityGloss.r - (1.0 - alpha.a);
	#else
		gl_FragColor.a = opacityGloss.r;
	#endif
}