...
namespace OgrePlugin
{
    ...
    public class ImageAtlasPage : IDisposable
    {
        ...
        public ImageAtlasPage(String textureName, String groupName, int width, int height)
        {
            ...
            texture = TextureManager.getInstance().createManual(textureName, groupName, TextureType.TEX_TYPE_2D, (uint)width, (uint)height, 1, 1, OgrePlugin.PixelFormat.PF_A8R8G8B8, TextureUsage.TU_STATIC_WRITE_ONLY, false, 0);
