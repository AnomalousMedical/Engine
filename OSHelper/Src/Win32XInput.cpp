//This is adapted from XInputDotNet by speps
...
extern "C" _AnomalousExport DWORD XInputGamePadGetState(DWORD dwUserIndex, XINPUT_STATE* pState)
{
...
extern "C" _AnomalousExport void XInputGamePadSetState(DWORD dwUserIndex, float leftMotor, float rightMotor)
{
	gXInputLoader.ensureLoaded();
