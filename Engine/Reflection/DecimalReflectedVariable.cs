...
{
    class DecimalReflectedVariable : ReflectedVariable
    {
        #region Constructors
        ...
        public DecimalReflectedVariable(MemberWrapper propInfo, Object instance)
        ...
        {
            setValue(NumberParser.ParseDecimal(value));
        }
