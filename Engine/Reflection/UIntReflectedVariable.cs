...
{
    class UIntReflectedVariable : ReflectedVariable
    {
        #region Constructors
        ...
        public UIntReflectedVariable(MemberWrapper propInfo, Object instance)
        ...
        {
            uint test;
            return uint.TryParse(value, out test);
        }
