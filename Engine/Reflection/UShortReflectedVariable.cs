...
{
    class UShortReflectedVariable : ReflectedVariable
    {
        #region Constructors
        ...
        public UShortReflectedVariable(MemberWrapper propInfo, Object instance)
        ...
        {
            ushort test;
            return ushort.TryParse(value, out test);
        }
