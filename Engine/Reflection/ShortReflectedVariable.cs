...
{
    class ShortReflectedVariable : ReflectedVariable
    {
        #region Constructors
        ...
        public ShortReflectedVariable(MemberWrapper propInfo, Object instance)
        ...
        {
            setValue(NumberParser.ParseShort(value));
        }
