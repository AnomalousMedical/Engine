...
{
    class Size2ReflectedVariable : ReflectedVariable
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        ...
        public Size2ReflectedVariable(MemberWrapper propInfo, Object instance)
        ...
        {
            float test;
            return Size2.parseString(value, out test, out test);
        }
