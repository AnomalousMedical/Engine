...
namespace Engine.ObjectManagement
{
    ...
    /// the entire interface. It serves primarily to hide functions from classes that would
    /// be accessing SimObjects directly, so for construction we have access to this class so
    /// elements can be added and removed, but when dealing with some other SimObject we
    /// will be accessing through the parent class and these functions will be hidden.
    /// </summary>
