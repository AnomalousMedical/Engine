...
namespace Engine.Resources
{
    public class VirtualFilesystemResourceProvider<T> : IResourceProvider<T>
    {
        ...
        public VirtualFilesystemResourceProvider(VirtualFileSystem virtualFileSystem)
            :this(virtualFileSystem, "")
        {

        }

        public VirtualFilesystemResourceProvider(VirtualFileSystem virtualFileSystem, String path)
        {
