...
extern "C" _AnomalousExport void EditBox_getOnlyText(MyGUI::EditBox* edit, UnicodeStringRetrieverCallback callback, void* handle)
{
	callback(edit->getOnlyText().c_str(), handle);
}
