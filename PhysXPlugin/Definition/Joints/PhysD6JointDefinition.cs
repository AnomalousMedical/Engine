...
namespace PhysXPlugin
{
    public class PhysD6JointDefinition: PhysJointDefinitionBase<PhysD6JointDesc, PhysD6Joint>
    {
        ...
        internal static PhysD6JointDefinition Create(String name, EditUICallback callback)
        {
        ...
        {
            return new PhysD6JointElement(Name, (PhysD6Joint)joint, scene, subscription);
        }
