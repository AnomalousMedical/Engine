...
namespace PhysXPlugin
{
    public class PhysCylindricalJointDefinition : PhysJointDefinitionBase<PhysCylindricalJointDesc, PhysCylindricalJoint>
    {
        ...
        internal static PhysCylindricalJointDefinition Create(String name, EditUICallback callback)
        {
        ...
        {
            return new PhysCylindricalJointElement(Name, (PhysCylindricalJoint)joint, scene, subscription);
        }
