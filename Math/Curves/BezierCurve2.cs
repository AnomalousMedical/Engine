...
{
    /// <summary>
    /// This class can generate 2d bezier curves.
    /// </summary>
    public class BezierCurve2
    {
        ...
        /// <summary>
        /// Create a bezier curve of cpts points from the source buffer b and
        /// store it in p. P must be large enough to store cpts number of
        /// points.
        /// </summary>
        /// <param name="b">The source buffer.</param>
        /// <param name="cpts">The number of points to create.</param>
        /// <param name="p">The destination buffer.</param>
