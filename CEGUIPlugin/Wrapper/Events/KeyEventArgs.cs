...
namespace CEGUIPlugin
{
    ...
    public class KeyEventArgs : WindowEventArgs
    {
        public KeyEventArgs()
        {
        ...
        public KeyEventArgs(Window window, uint codepoint, KeyScan scancode, uint sysKeys)
        {
            Codepoint = codepoint;
            Scancode = scancode;
            SysKeys = sysKeys;
        ...
        public KeyScan Scancode { get; internal set; }
