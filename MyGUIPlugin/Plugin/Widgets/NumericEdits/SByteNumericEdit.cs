...
namespace MyGUIPlugin
{
    public class SByteNumericEdit
    {
        ...
        private SByte keyFocusValue = 0;
        private bool hasKeyFocus = false;

        public SByteNumericEdit(EditBox edit)
        {
            this.edit = edit;
        ...
        public SByteNumericEdit(EditBox edit, Button upButton, Button downButton)
            :this(edit)
        {
        ...
        public SByte Increment { get; set; }
        ...
        {
            SByte newVal = (SByte)(Value - Increment);
            if (newVal < minValue)
            {
                newVal = minValue;
            }
        ...
        void edit_MouseWheel(Widget source, EventArgs e)
        {
            if (hasKeyFocus)
            {
                ...
                SByte newVal = (SByte)(Value + Increment * wheelDelta);
                if (newVal > maxValue)
                {
                    newVal = maxValue;
                }
