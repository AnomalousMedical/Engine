...
{
    public class DoubleNumericEdit
    {
        ...
        private Double keyFocusValue = 0;
        private bool hasKeyFocus = false;

        public DoubleNumericEdit(EditBox edit)
        {
            this.edit = edit;
        ...
        public DoubleNumericEdit(EditBox edit, Button upButton, Button downButton)
            :this(edit)
        {
        ...
        void edit_MouseWheel(Widget source, EventArgs e)
        {
            if (hasKeyFocus)
            {
                ...
                Double newVal = Value + Increment * wheelDelta;
                if (newVal > maxValue)
                {
                    newVal = maxValue;
                }
