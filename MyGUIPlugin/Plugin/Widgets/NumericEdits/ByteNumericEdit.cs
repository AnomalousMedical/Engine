...
namespace MyGUIPlugin
{
    public class ByteNumericEdit
    {
        ...
        private Byte keyFocusValue = 0;
        private bool hasKeyFocus = false;

        public ByteNumericEdit(EditBox edit)
        {
            this.edit = edit;
        ...
        public ByteNumericEdit(EditBox edit, Button upButton, Button downButton)
            :this(edit)
        {
        ...
        {
            Byte newVal = (Byte)(Value - Increment);
            if (newVal < minValue)
            {
                newVal = minValue;
            }
        ...
        void edit_MouseWheel(Widget source, EventArgs e)
        {
            if (hasKeyFocus)
            {
                ...
                Byte newVal = (Byte)(Value + Increment * wheelDelta);
                if (newVal > maxValue)
                {
                    newVal = maxValue;
                }
