...
namespace MyGUIPlugin
{
    public class Int32NumericEdit
    {
        ...
        private Int32 keyFocusValue = 0;
        private bool hasKeyFocus = false;

        public Int32NumericEdit(EditBox edit)
        {
            this.edit = edit;
        ...
        public Int32NumericEdit(EditBox edit, Button upButton, Button downButton)
            :this(edit)
        {
        ...
        void edit_MouseWheel(Widget source, EventArgs e)
        {
            if (hasKeyFocus)
            {
                ...
                Int32 newVal = Value + Increment * wheelDelta;
                if (newVal > maxValue)
                {
                    newVal = maxValue;
                }
