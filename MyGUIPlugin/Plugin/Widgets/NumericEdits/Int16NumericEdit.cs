...
namespace MyGUIPlugin
{
    public class Int16NumericEdit
    {
        ...
        public Int16NumericEdit(EditBox edit, Button upButton, Button downButton)
            :this(edit)
        {
        ...
        public Int16 Increment { get; set; }
        ...
        {
            Int16 newVal = (Int16)(Value - Increment);
            if (newVal < minValue)
            {
                newVal = minValue;
            }
        ...
        void edit_MouseWheel(Widget source, EventArgs e)
        {
            if (hasKeyFocus)
            {
                ...
                Int16 wheelDelta = me.RelativeWheelPosition > 0 ? (Int16)1 : (Int16)(-1);
                Int16 newVal = (Int16)(Value + Increment * wheelDelta);
                if (newVal > maxValue)
                {
                    newVal = maxValue;
                }
