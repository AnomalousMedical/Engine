...
namespace MyGUIPlugin
{
    ...
    {
        private static readonly int ButtonHeight = ScaleHelper.Scaled(10);
        ...
        {
            Button button = (Button)scrollView.createWidgetT("Button", "TimelineButton", (int)left, 0, width > TimelineViewButton.MinButtonSize ? (int)width : TimelineViewButton.MinButtonSize, ButtonHeight, Align.Left | Align.Top, "");
