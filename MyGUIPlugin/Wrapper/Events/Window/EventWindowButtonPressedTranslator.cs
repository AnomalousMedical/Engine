...
, IntPtr instanceHandle
        ...
        class CallbackHandler : IDisposable
        {
            ...
            public IntPtr create(EventWindowButtonPressedTranslator obj, Widget widget)
            {
                handle = GCHandle.Alloc(obj);
                return EventWindowButtonPressedTranslator_Create(widget.WidgetPtr, nativeEventCallback, GCHandle.ToIntPtr(handle));
            }
