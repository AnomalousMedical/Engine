...
, IntPtr instanceHandle
        ...
        class CallbackHandler : IDisposable
        {
            ...
            private static void nativeEvent(IntPtr widget, bool focus, IntPtr instanceHandle)
            {
                ...
                (handle.Target as EventRootMouseChangeFocusTranslator).nativeEvent(widget, focus);
            }

            private GCHandle handle;

            public IntPtr create(EventRootMouseChangeFocusTranslator obj, Widget widget)
            {
                handle = GCHandle.Alloc(obj);
                return EventRootMouseChangeFocusTranslator_Create(widget.WidgetPtr, nativeEventCallback, GCHandle.ToIntPtr(handle));
            }
