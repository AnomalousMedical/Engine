...
{
    class EventMouseButtonDoubleClickTranslator : MyGUIWidgetEventTranslator
    {
...
, IntPtr instanceHandle
        ...
        class CallbackHandler : IDisposable
        {
            ...
            private static void nativeEvent(IntPtr widget, IntPtr instanceHandle)
            {
                ...
                (handle.Target as EventMouseButtonDoubleClickTranslator).nativeEvent(widget);
            }

            private GCHandle handle;

            public IntPtr create(EventMouseButtonDoubleClickTranslator obj, Widget widget)
            {
                handle = GCHandle.Alloc(obj);
                return EventMouseButtonDoubleClickTranslator_Create(widget.WidgetPtr, nativeEventCallback, GCHandle.ToIntPtr(handle));
            }
